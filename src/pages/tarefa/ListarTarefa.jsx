...
const ListarTarefa = () => {
  ...
  const handleDeletar = (id) => {
    ...
    return(
    <>
    <Card sx={{ bgcolor: '#e0bbf1', borderRadius: 4 }}>
        <CardHeader
          title="Tarefas"
        ...
        /> 
        <CardContent>
            <TableContainer component={Paper} sx={{ bgcolor: '#f3e5f5' }}>
            <Table sx={{ minWidth: 650 }} size="small" aria-label="a dense table">
                ...
                {tarefas.map((row, indice) => (
                    ...
                    >
                      ...
                      <Button variant="contained" sx={{ backgroundColor: '#9c27b0' }} onClick={() => handleEditar(row.idTarefa)}>
                        <EditIcon fontSize="small" />
                      </Button>
                    </TableCell>
                    <TableCell align="center">
                      <Button variant="contained" sx={{ backgroundColor: '#d32f2f' }} onClick={() => handleDeletar(row.idTarefa)}>
        ...
        <CardActions>
          <Button size="small" variant="contained" sx={{ backgroundColor: '#9c27b0' }} onClick={handleOpen}>
            Criar Tarefa
          </Button>
          <Button size="small" variant="outlined" sx={{ color: '#9c27b0', borderColor: '#9c27b0' }}>Cancelar</Button>
        </CardActions>
    </Card>
    <div>
      <Modal
